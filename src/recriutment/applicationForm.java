...
public class applicationForm extends javax.swing.JFrame {
    ...
    private int User_id;
    public applicationForm(int User_id,int vacancyId) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Fill Application");
        ...
        jLabel5.setText("Applicant brief:");
        ...
        AE.setText("jTextField2");

        Q.setText("jTextField3");

        AB.setText("jTextField4");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String applicantName=AN.getText();
        String applicantEmail=AE.getText();
        String qualifications=Q.getText();
        String applicantbrief=AB.getText();
        
            ArrayList<Application> Applications = D.getallApplications();
                boolean found = false;

                for (int i = 0; i < Applications.size(); i++)
                {
                   if(Applications.get(i).getApplicantName().equals(applicantName)&& Applications.get(i).getQualifications().equals(qualifications)){
                       JOptionPane.showMessageDialog(null,"this application already exists");
                       found=true;
                   }

                }
                    if(found == false) {
                      D.InsertApplication(applicantName, applicantEmail, qualifications, applicantbrief, User_id, vacancy_id);
